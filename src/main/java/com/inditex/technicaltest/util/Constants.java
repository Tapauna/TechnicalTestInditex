...
public class Constants {
  ...
  public static final String NOT_RECORDS_FOUND_MESSAGE= "There are no rate records to be applied for this product.";
  public static final String NOT_RATES_FOUND_MESSAGE= "No rates apply on the date indicated.";
}
